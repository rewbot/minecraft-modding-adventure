 ...
 */
public class MmaWorldGenMinable extends WorldGenerator {
    private final IBlockState oreBlock;
    /** The number of blocks to generate. */
    private final int numberOfBlocks;
    private final Predicate<IBlockState> predicate;

    public MmaWorldGenMinable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockHelper.forBlock(Blocks.stone));
    }

    public MmaWorldGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
